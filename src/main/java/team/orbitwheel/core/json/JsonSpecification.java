...
public final class JsonSpecification {
    ...
    public static ObjectMapper getStandardObjectMapper() {
        ...
        simpleModule.addSerializer(Percentage.class, PercentageSerializer.INSTANCE);
        simpleModule.addDeserializer(Percentage.class, PercentageDeserializer.INSTANCE);
